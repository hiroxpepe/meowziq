...
+ phrase.json の内容
    ...
    |3|note     |Phrase の内容を記述します ※単一の設定|
    |4|data.note|Phrase の内容を記述します ※複数の設定|
    |5|data.inst|Phrase の楽器(ドラム)を指定します、※ drum のみ、記述方法については後述します|
+ Phrase の記述例
    ```json
    {
        "phrase": [
...
+ player.json の内容
    ...
    |3|inst|Player の楽器を記述します、※ drum 以外、記述方法については後述します|
+ Player の記述例
    ```json
    {
        "player": [
